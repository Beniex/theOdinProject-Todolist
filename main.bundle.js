...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,WAAW;IACX,YAAY;IACZ,SAAS;AACb;AACA;IACI,UAAU;IACV,WAAW;IACX,wBAAwB;IACxB,aAAa;IACb,qCAAqC;IACrC,kCAAkC;IAClC,aAAa;IACb,SAAS;;;EAGX;EACA;IACE,mBAAmB;IACnB,YAAY;IACZ,iBAAiB;IACjB,gBAAgB;EAClB;;AAEF;IACI,yBAAyB;IACzB,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,yBAAyB;IACzB,kBAAkB;IAClB,eAAe;IACf,SAAS;AACb;;AAEA;IACI,cAAc;IACd,sBAAsB;IACtB,mBAAmB;IACnB,qBAAqB;IACrB,SAAS;AACb;;;AAGA;IACI,yBAAyB;IACzB,kBAAkB;IAClB,eAAe;IACf,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,kBAAkB;IAClB,gBAAgB;AACpB;;AAEA;IACI,yBAAyB;IACzB,kBAAkB;IAClB,eAAe;IACf,aAAa;IACb,qCAAqC;IACrC,kCAAkC;IAClC,aAAa;IACb,SAAS;;AAEb;;AAEA;IACI,SAAS;IACT,UAAU;IACV,qBAAqB;IACrB,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,uBAAuB;IACvB,yBAAyB;IACzB,iBAAiB;IACjB,mBAAmB;IACnB,SAAS;AACb;;AAEA;IACI,YAAY;IACZ,eAAe;IACf,gBAAgB;AACpB;;AAEA;IACI,wBAAwB;IACxB,kBAAkB;IAClB,eAAe;IACf,cAAc;IACd,sBAAsB;IACtB,mBAAmB;IACnB,qBAAqB;IACrB,SAAS;AACb;;AAEA;IACI,mBAAmB;IACnB,gBAAgB;IAChB,YAAY;;AAEhB","sourcesContent":["html, body{\n    width: 100%;\n    height: 100%;\n    margin: 0;\n}\nbody{\n    width: 95%;\n    height: 90%;\n    background-color:#264653;\n    display: grid;\n    grid-template-columns: repeat(8, 1fr);\n    grid-template-rows: repeat(6, 1fr); \n    padding: 30px;\n    gap: 30px;\n\n\n  }\n  body>*{\n    border-radius: 20px;\n    color: beige;\n    font-size: medium;\n    font-weight: 700;\n  }\n\n#filters{\n    background-color: #e9c46a;\n    grid-column: 1 / 2;\n    grid-row: 1 / 4;\n}\n\n#projectList{\n    background-color: #e9c46a;\n    grid-column: 1 / 2;\n    grid-row: 4 / 7;\n    gap: 10px;\n}\n\n#projectList>ul{\n    display: flex ;\n    flex-direction: column;\n    align-items: center;\n    justify-items: center;\n    gap: 10px;\n}\n\n\n#projectName{\n    background-color: #2a9d8f;\n    grid-column: 2 / 6;\n    grid-row: 1 / 2;   \n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-size: x-large;\n    font-weight: 700;\n}\n\n#taskCards{\n    background-color: #e76f51;\n    grid-column: 2 / 6;\n    grid-row: 2 / 7; \n    display: grid;\n    grid-template-columns: repeat(3, 1fr);\n    grid-template-rows: repeat(3, 1fr); \n    padding: 10px;\n    gap: 10px;\n\n}\n\n#taskCards>*{\n    margin: 0;\n    padding: 0;\n    list-style-type: none;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n    background-color: #f4a261;\n    border: solid red;\n    border-radius: 10px;\n    gap: 10px;\n}\n\n#taskCards>button{\n    color: white;\n    font-size: 80px;\n    font-weight: 700;\n}\n\n#workSpace{\n    background-color:#f4a261;\n    grid-column: 6 / 9;\n    grid-row: 1 / 7; \n    display: flex ;\n    flex-direction: column;\n    align-items: center;\n    justify-items: center;\n    gap: 10px;\n}\n\n#workSpace>button{\n    font-size: xx-large;\n    font-weight: 900;\n    color: white;\n\n}"],"sourceRoot":""}]);
// Exports
...
const updateDisplay = () => {
    ...
    cleanTaskCards();
    clearWorkingSpace();   
    populateProjectList((0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.retrieveStoredProjects)()); 
    populateTaskCards((0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.getWorkingProject)());
    updateProjectName(); 
}

function updateProjectName(){
    ProjectNameElement.textContent = (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.getWorkingProject)().name; 
}
...
function populateProjectList (projects){
    for (let i = 0; i<projects.length; i++){
        ...
        listItem.addEventListener('click', () => {
            (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.setWorkingProject)(projects[i]); 
            updateDisplay(); 
        })
...
function updateWorkingSpace(task) {
    ...
    workSpaceElement.addEventListener('submit', function(event) {
        event.preventDefault();
        event.stopImmediatePropagation(); 
        saveWorkingTaskInWorkingProject(); 
...
function addTheAddTaskCard(){
    ...
    addTaskCardElement.addEventListener('click', ()=>{
        var workingTask = (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.getEmptyTask)(); 
        updateWorkingSpace(workingTask);  
    })
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getEmptyTask: () => (/* binding */ getEmptyTask),
/* harmony export */   getWorkingProject: () => (/* binding */ getWorkingProject),
/* harmony export */   initializeProjects: () => (/* binding */ initializeProjects),
/* harmony export */   retrieveStoredProjects: () => (/* binding */ retrieveStoredProjects),
...
const DefaultTask = new Task ("Main", "First Task", "This is the default task initialized", (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(2022, 0, 22), "yyyy-MM-dd"), "Low"); 
const DefaultTask1 = new Task ("Main", "seconde Task", "This is the default task initialized", (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(2022, 0, 24), "yyyy-MM-dd"), "High"); 
...
const setNewTask = (taskname, taskdescription, taskduedate, taskprioritylevel) =>{
